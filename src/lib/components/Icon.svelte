<script lang="ts">
  ...
  const icons: Record<string, string> = {
    ...
    // WiFi icons for different signal levels (0-3 bars + full)
    ...
    'wifi-off': 'M22.99 9C19.15 5.16 13.8 3.76 8.84 4.78l2.52 2.52c3.47-.17 6.99 1.05 9.63 3.7l2-2zm-4 4c-1.29-1.29-2.84-2.13-4.49-2.56l3.53 3.53.96-.97zM2 3.05L5.07 6.1C3.6 6.82 2.22 7.78 1 9l2 2c1.02-1.02 2.17-1.85 3.41-2.5l2.52 2.52C7.14 11.65 5.56 12.57 4.2 14l2 2c1.35-1.35 2.99-2.27 4.74-2.79l8.49 8.49 1.41-1.41L3.41 1.64 2 3.05zM9 17l3 3 3-3c-1.65-1.66-4.34-1.66-6 0z',
    'wifi-1': 'M12 18c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2z', // Only dot (weakest)
    'wifi-2': 'M9 17l3 3 3-3c-1.65-1.66-4.34-1.66-6 0z', // One arc (weak)
    'wifi-3': 'M5 13l2 2c2.76-2.76 7.24-2.76 10 0l2-2C15.14 9.14 8.87 9.14 5 13zm4 4l3 3 3-3c-1.65-1.66-4.34-1.66-6 0z', // Two arcs (medium)
    ...
    'collapse': 'M19.5 3.5L18 2l-6 6-6-6-1.5 1.5 6 6-6 6L6 17l6-6 6 6 1.5-1.5-6-6z',
    ...
    'speaker': 'M17 2H7c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-5 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm0 16c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zm0-10c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z',
    'check': 'M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z',
    'volume-x': 'M16.5 12c0-1.77-1.02-3.29-2.5-4.03v2.21l2.45 2.45c.03-.2.05-.41.05-.63zm2.5 0c0 .94-.2 1.82-.54 2.64l1.51 1.51C20.63 14.91 21 13.5 21 12c0-4.28-2.99-7.86-7-8.77v2.06c2.89.86 5 3.54 5 6.71zM4.27 3L3 4.27 7.73 9H3v6h4l5 5v-6.73l4.25 4.25c-.67.52-1.42.93-2.25 1.18v2.06c1.38-.31 2.63-.95 3.69-1.81L19.73 21 21 19.73l-9-9L4.27 3zM12 4L9.91 6.09 12 8.18V4z',

    // Redesign nav (Lucide line paths, simplified)
    'music-2':      'M9 18V5l12-2v13M9 9l12-2M9 18a3 3 0 1 1-6 0 3 3 0 0 1 6 0zm12-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0z',
    'audio-lines':  'M2 10v3M6 6v11M10 3v18M14 8v7M18 5v13M22 10v3',
    'refresh-cw':   'M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8M21 3v5h-5',
    'user':         'M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z',
    'vinyl-record': 'M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0-18 0M12 12m-1 0a1 1 0 1 0 2 0a1 1 0 1 0-2 0M12 12m-5 0a5 5 0 1 0 10 0a5 5 0 1 0-10 0',
    'play-fill':    'M5 3l14 9-14 9V3z',
    'pause-fill':   'M7 4h4v16H7V4zm6 0h4v16h-4V4z',
    'skip-back-fill': 'M19 20L9 12l10-8v16zM5 19V5h2v14H5z',
    'skip-forward-fill': 'M5 4l10 8-10 8V4zm14 0v16h-2V4h2z'
  };
</script>

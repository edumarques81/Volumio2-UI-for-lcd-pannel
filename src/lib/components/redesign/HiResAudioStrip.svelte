<script lang="ts">
   ...
   * `library-screen-target-2026-05-08.png`:
   *
   *   [eq glyph] Hi-Res Audio | [HI-RES / 96kHz badge] | 24-bit / 96 kHz | FLAC
   *
   * When the album is not high-res (e.g. 16/44.1 lossless or any lossy
   * codec) the leading "Hi-Res Audio" cluster is omitted and the
   * component degrades to a plain muted-gray spec strip:
   *
  ...
  <div class="hi-res-audio-strip" data-testid="hi-res-audio-strip">
    {#if showHiResCluster}
      <span class="cluster">
        ...
        <span class="label">Hi-Res Audio</span>
      </span>

...
# Usage: ./switch-kiosk.sh [stellar|original]
#
# Switches the Volumio kiosk display between:
# - stellar: Stellar Volumio on port 8080
...
case "$1" in
  stellar)
    echo "=========================================="
    echo "Switching to Stellar Volumio"
    echo "=========================================="
  ...
  *)
    ...
    echo ""
    echo "Usage: $0 [stellar|original|status]"
    echo ""
    echo "Commands:"
    echo "  stellar       - Switch to Stellar Volumio (port 8080)"
...
echo "  Stellar Volumio:          http://${VOLUMIO_IP}:8080"
